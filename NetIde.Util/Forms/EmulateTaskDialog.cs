...
namespace NetIde.Util.Forms
{
    ...
    internal partial class EmulateTaskDialog : Form
    {
            ...
            if ( !String.IsNullOrEmpty ( this.taskDialog.Footer ) )
            {
                ...
                switch ( this.taskDialog.FooterIcon )
                {
                    ...
                    case TaskDialogIcon.Shield:
                        this.pictureBoxFooterAreaIcon.Image = NeutralResources.TaskDialog_Shield.ToBitmap ( ).GetThumbnailImage ( 16, 16, null, IntPtr.Zero );
                        break;
        ...
        private void BuildFormMainArea ( )
        {
            switch ( this.taskDialog.MainIcon )
            {
                ...
                case TaskDialogIcon.Information:
                    ...
                    break;
                case TaskDialogIcon.Shield:
                    this.pictureBoxMainAreaIcon.Image = NeutralResources.TaskDialog_Shield.ToBitmap();
                    break;
                case TaskDialogIcon.Warning:
        ...
        protected override void WndProc ( ref System.Windows.Forms.Message m )
        {
            switch ( m.Msg )
            {
                case (int)NativeMethods.TASKDIALOG_MESSAGES.TDM_SET_PROGRESS_BAR_POS:
