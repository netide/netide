...
namespace NetIde.Util.Forms
{
    ...
    internal partial class EmulateExpInfoButton : System.Windows.Forms.UserControl
    {
        ...
        private void SetState ( )
        {
            if ( this.isExpanded )
            {
                this.pictureBox.Image = NeutralResources.TaskDialog_ChevronLess;
            ...
            {
                this.pictureBox.Image = NeutralResources.TaskDialog_ChevronMore;
        ...
        private void EmulateExpInfoButton_MouseDown ( object sender, MouseEventArgs e )
        {
            this.pictureBox.Image = this.isExpanded
                ? NeutralResources.TaskDialog_ChevronLessPressed
                : NeutralResources.TaskDialog_ChevronMorePressed;
        }

        private void EmulateExpInfoButton_MouseEnter ( object sender, EventArgs e )
        {
            this.pictureBox.Image = this.isExpanded
                ? NeutralResources.TaskDialog_ChevronLessHovered
                : NeutralResources.TaskDialog_ChevronMoreHovered;
        }

        private void EmulateExpInfoButton_MouseLeave ( object sender, EventArgs e )
        {
            this.pictureBox.Image = this.isExpanded
                ? NeutralResources.TaskDialog_ChevronLess
                : NeutralResources.TaskDialog_ChevronMore;
        }
